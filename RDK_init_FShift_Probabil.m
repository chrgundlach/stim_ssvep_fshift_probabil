function [colmat,dotmat,dotsize,rdkidx,frames,varargout] = RDK_init(scr,Propixx,RDK,trial,cross)
...
%
%
% To do: start from line 187 onwards...
...
%             xlim([0 100])
    ...
    colmat(4,:,:) = alphamat; % replace alpha values with adjusted alpha values
